package com.sh.springbootdemo.aspect;

import com.alibaba.fastjson.JSONObject;
import com.sh.springbootdemo.bean.ResultVO;
import com.sh.springbootdemo.controller.UserController;
...
public class LogAspect {
     ...
     */
    @Pointcut("execution(public * com.sh.springbootdemo.controller..*.*(..))")
